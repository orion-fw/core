...
const NW: NW = {
	...
	CharacterData: {
		...
		coords: new Vector4(characterConfig.defaultCoords.x, characterConfig.defaultCoords.y, characterConfig.defaultCoords.z, characterConfig.defaultCoords.w),
	}
};
...
const defaultPedHash: number = joaat(characterConfig.defaultPed);
let spawnCoords: Vector4 = new Vector4(characterConfig.defaultCoords.x, characterConfig.defaultCoords.y, characterConfig.defaultCoords.z, characterConfig.defaultCoords.w);
